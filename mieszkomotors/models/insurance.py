...
class Insurance(PublicationTracker):
    ...
    partial_payments = models.ForeignKey("InsurancePartialPayments",
                                         on_delete=models.CASCADE,
                                         related_name="partial_payment",
                                         null=True,
                                         blank=True)
...
class InsurancePartialPayments(PublicationTracker):
    ...
    payment_1 = models.DecimalField(max_digits=10, decimal_places=2,
                                    null=True, blank=True)
    payment_1_status = models.CharField(max_length=2, choices=STATUSES)
    payment_2 = models.DecimalField(max_digits=10, decimal_places=2,
                                    null=True, blank=True)
    payment_2_status = models.CharField(max_length=2, choices=STATUSES)
    payment_3 = models.DecimalField(max_digits=10, decimal_places=2,
                                    null=True, blank=True)
    payment_3_status = models.CharField(max_length=2, choices=STATUSES)
    payment_4 = models.DecimalField(max_digits=10, decimal_places=2,
                                    null=True, blank=True)

...
from mieszkomotors.models.events import CarEvent, InsuranceEvent, \
    GenericEvent, CarEventMail, InsuranceEventMail, GenericEventMail
...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        Creates Mail objects that stores event data
            ...
            for carevent in carevents:
                ...
                if hasattr(owner.client, 'individual_customer'):
                    car_event_data = {
                            ...
                            carevent.car.model,
                            'license_plates':
                            carevent.car.license_plates,
                            'current_car_review_date':
                            str(carevent.car.current_car_review_date),
                            'car_review_renewal_date':
                            str(carevent.car.car_review_renewal_date)
                        }
                    CarEventMail.objects.get_or_create(
                        car_event=carevent,
                        email_data=car_event_data)
                    ...
                    car_event_data = {
                            ...
                            'phone':
                            str(owner.client.
                                self_employed_customer.phone_number),
                            'brand':
                            carevent.car.brand,
                            'model':
                            carevent.car.model,
                    ...
                    car_event_data = {
                            'company_name':
                            owner.client.enterprise_customer.company_name,
                            'email':
        ...
        if insurance_events:
            for insurance_event in insurance_events:
                owner = CarOwner.objects.filter(
                    car=insurance_event.insurance.car.pk).filter(
                    status='a')[0]
                ...
                if hasattr(owner.client, 'individual_customer'):
                    insurance_event_data = {
                        ...
                        str(owner.client.individual_customer.phone_number),
                        'price':
                        str(insurance_event.insurance.price),
                        'current_insurance_date':
                        str(insurance_event.insurance.current_insurance_date),
                        'insurance_renewal_date':
                        str(insurance_event.insurance.insurance_renewal_date),
                    }
                    InsuranceEventMail.objects.get_or_create(
                        insurance_event=insurance_event,
                        email_data=insurance_event_data)
                elif hasattr(owner.client, 'self_employed_customer'):
                    insurance_event_data = {
                        'car':
                        str(insurance_event.insurance.car),
                        'owner_first_name':
                        owner.client.self_employed_customer.first_name,
                        'owner_last_name':
                        owner.client.self_employed_customer.last_name,
                        ...
                        owner.client.self_employed_customer.email,
                        'phone':
                        str(owner.client.self_employed_customer.phone_number),
                        'price':
                        str(insurance_event.insurance.price),
                        'current_insurance_date':
                        str(insurance_event.insurance.current_insurance_date),
        ...
        if generic_events:
            for generic_event in generic_events:
                ...
                GenericEventMail.objects.get_or_create(
                    generic_event=generic_event,
                    email_data=generic_event_data)

...
def handle_spring_tyres_task(spring_tyres_replacement_event_mail):
    sleep(3)
    obj = SpringTyresReplacementEventMail.objects.get(
        id=spring_tyres_replacement_event_mail)
    print(obj)
    obj.send_email()
...
def handle_winter_tyres_task(winter_tyres_replacement_event_mail):
    sleep(3)
    obj = \
        WinterTyresReplacementEventMail.objects.get(
            id=winter_tyres_replacement_event_mail)
    print(obj)
    obj.send_email()

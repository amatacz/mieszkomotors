...
from mieszkomotors.models.owner import IndividualCustomer, Customer, \
    EnterpriseCustomer, SelfEmployedCustomer
from mieszkomotors.permissions import IsStaffOrReadOnly
from mieszkomotors.serializers import CarEventsSerializer, \
    IndividualCustomerSerializer, CarSerializer, \
    InsuranceEventsSerializer, CarOwnerSerializer, \
    InsuranceSerializer, CustomerSerializer, \
    SelfEmployedCustomerSerializer, GenericEventSerializer, \
